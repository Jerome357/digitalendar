 ...
 */
final class Version20190701113201 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, city_id_id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, picture VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, date_start DATETIME NOT NULL, url VARCHAR(255) DEFAULT NULL, date_end DATETIME NOT NULL, price NUMERIC(10, 2) NOT NULL, is_valid TINYINT(1) NOT NULL, INDEX IDX_3BAE0AA73CCE3900 (city_id_id), INDEX IDX_3BAE0AA7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA73CCE3900 FOREIGN KEY (city_id_id) REFERENCES city (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY FK_3BAE0AA73CCE3900');
